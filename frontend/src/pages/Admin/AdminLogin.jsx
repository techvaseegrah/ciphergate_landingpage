...
const AdminLogin = () => {
    ...
    const [credentials, setCredentials] = useState({
        loginType: 'email', // 'email' or 'username'
        email: '',
        username: '',
        password: '',
        subdomain
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-white text-black overflow-hidden relative">
            ...
            <motion.button
                ...
                className="absolute top-6 left-6 flex items-center gap-2 text-gray-600 hover:text-[#0d9488] transition-colors group"
            >
                    ...
                    <form onSubmit={handleLoginSubmit} className="space-y-5">
                        ...
                        <div className="flex justify-center mb-4">
                            <div className="inline-flex rounded-md shadow-sm" role="group">
                                <button
                                    type="button"
                                    className={`px-4 py-2 text-sm font-medium rounded-l-lg ${credentials.loginType === 'email'
                                        ? 'bg-[#0d9488] text-white'
                                        : 'bg-white text-[#0d9488] border border-[#0d9488]'
                                        }`}
                                ...
                                <button
                                    type="button"
                                    className={`px-4 py-2 text-sm font-medium rounded-r-lg ${credentials.loginType === 'username'
                                        ? 'bg-[#0d9488] text-white'
                                        : 'bg-white text-[#0d9488] border border-[#0d9488] border-l-0'
                                        }`}
                    ...
                    <form onSubmit={handleResetPasswordSubmit} className="space-y-5">
                        ...
                        >
                            ...
                            <input
                                ...
                                className="w-full px-4 py-3 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0d9488] focus:border-transparent text-black pr-10"
