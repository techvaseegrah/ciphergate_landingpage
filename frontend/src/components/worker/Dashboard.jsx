  ...
  return (
    ...
    <div className="w-full overflow-x-hidden">
      ...
      <div className="mt-6">
        ...
        <Card
          title={
            <div className="flex items-center text-xs font-bold text-slate-800 uppercase tracking-wider">
          ...
          {tasks.length === 0 ? (
            ...
            <div className="space-y-4">
              {(showAllRecentTasks ? tasks : tasks.slice(0, 5)).map((task) => (
                <div key={task._id} className="border-b border-gray-100 pb-4 last:border-b-0 last:pb-0">
